...
/**
 * EvRaidRankSecond Model
 *
 */
class EvRaidRankSecond extends AppModel {

    public function getList($limit, $where = array()) {

        $field = array('EvRaidRankSecond.rank', 'EvRaidRankSecond.user_id', 'EvRaidRankSecond.point',  'User.user_name', 'UserCard.card_id');
        $order = array('id ASC');
        ...
        $joins = array(
            array('table' => 'users',
                ...
                'type' => 'inner',
                'conditions' => array(
                    'EvRaidRankSecond.user_id = User.user_id',
                ),
            ),
