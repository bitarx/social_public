...
/**
 * UserRaids Controller
 *
 * @property UserRaid $UserRaid
 * @property PaginatorComponent $Paginator
 */
class UserRaidsController extends ApiController {
    ...
    public function find() {
        ...
        if ($this->request->is(array('ajax'))) {
            ...
            $list = $this->UserRaid->getAllFind($this->request->query, $fields);
            $this->setJson($list);
        }
    }
	...
	public function init() {
        ...
        if ($this->request->is(array('ajax'))) {
            ...
            if ($this->UserRaid->save($this->request->query)) {
                $ary = array('result' => 1);
            } else {
                $ary = array('result' => 0);
            }
