...
<html lang="ja">
    ...
    <script type="text/javascript">
        //使用する画像リスト
        var images = [
            { src: "<{$smarty.const.IMG_URL}>tutorial/scene_0_1.jpg", id: "bg" },
        ];

        // キャラセリフ
        var eventData001 = [
            { text: "<{$row.tutorial_words}>", name: "", bgID: "bg", charID: "" },
        ];
    ...
    <script type="text/javascript">
        ...
        var scenarioComplete = function( eventsID ) {
            ...
            location.href = "<{$smarty.const.URL_PRE}><{$smarty.const.BASE_URL}>Tutorials/tutorial_15";
        }
